...
class Skeleton : public NS::Copying<MDL::Object>
{
    ...
    class Skeleton*             initWithName(const NS::String name, const NS::Array* jointPaths);
};

// Protocol
class JointAnimation {};
                                // !!!: Uncertain
class PackedJointAnimation : public NS::Copying<MDL::Object, MDL::JointAnimation>
{
    ...
    // initWithName:jointPaths:
    class PackedJointAnimation*             initWithName(const NS::String name, const NS::Array* jointPaths);
};

                                // !!!: Uncertain
class AnimationBindComponent : public NS::Copying<MDL::Object, MDL::Component>
{
